...
Finally, we use this method for $\lambda = \lambda_0 \pm \omega_0$. [WE WILL ACTUALLY NEED TO GO TO 4TH ORDER HERE OR FIND A CORRECTION TERM, SINCE NOT VERY GOOD TO ONLY QUADRATIC ORDER]. $H_3(\xvec)$ has a complex conjugate pair of eigenvalues, where the real part is given by
\begin{equation}
