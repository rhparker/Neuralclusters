...
\noteAKB{Are these supposed to be 2-1-1 below, rather than 2-2-1? Yes. Fixed.}
\revised{
...
\noteAKB{Need to check what follows. Symmetry group is different because it includes now $S_{n_{C_1}}\times S_{n_{C_2}}$.  Also check that $V$ is as in 6.1; probably true but double-check. I added more details.}
\revised{
