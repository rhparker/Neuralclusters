...
% We could put something here about how there appear to be no stable fixed points for large $g$, just periodic orbits.
...
\begin{align*}
\lambda_{C_1}^*(g) = \frac{g-g_C}{g} \left( 1 - \frac{3}{1-\beta_C+\beta_C^2 }\right), \quad
\lambda_{C_2}^*(g) = \frac{g-g_C}{g} \left( 1 - \frac{3 \beta_C^3}{1-\beta_C+\beta_C^2 }\right), \quad
...
\begin{align*}
    -2\left( \frac{g - g_C}{g_C} \right)  && g \geq g_C
\end{align*}
