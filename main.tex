...
We can also allow the inhibitory cells to be clustered, while the excitatory cells remain unclustered. Briefly, supposed the inhibitory cells are grouped into $n_{C_i}$ inhibitory clusters of size $p_i$.
