...
plot(g1,x1(:,5),'--', 'LineWidth', lw, 'Color', c1 );
plot(g1s,x1s(:,1),'-', 'LineWidth', lw, 'Color', c1 );
plot(g1s,x1s(:,5),'-', 'LineWidth', lw, 'Color', c1 );
% balance = 3
plot(g3,x3(:,1),'--', 'LineWidth', lw, 'Color', c2 );
plot(g3,x3(:,5),'--', 'LineWidth', lw, 'Color', c2 );
plot(g3s,x3s(:,1),'-', 'LineWidth', lw, 'Color', c2 );
plot(g3s,x3s(:,5),'-', 'LineWidth', lw, 'Color', c2 );
